#!/usr/bin/env python3
"""Improved RAG system with category-aware routing and reranking."""
...
class ToMRAGv2:
    """Improved RAG system with category-aware routing and keyword reranking."""
    ...
    def __init__(
        ...
        # If use_rewritten is True, append "_rewritten" to index_dir
    ...
    def build_index(self, force_rebuild: bool = False, num_samples: int = -1):
        ...
        for source in sources:
            # Select file based on use_rewritten flag
            if self.use_rewritten:
    ...
    def search(
        ...
        # Check if category has no valid sources (skip it)
