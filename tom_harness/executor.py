...
class Executor:
    ...
    def _collect_skill_votes(accumulated: dict[str, Any], options: dict[str, str]) -> list[str]:
        ...
        votes: list[str] = []
        # B7 fix: scan only the *direct* values of accumulated_results;
        # do NOT recurse into nested dicts/lists. Earlier we recursed and
        # could accidentally pick up recommendation/answer_letter strings
